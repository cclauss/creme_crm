...
from typing import Iterable, Iterator, Optional, Type  # DefaultDict, Dict
...
class CrudityFetcherManager:
    ...
    def __init__(self, fetchers_config: Optional[Iterable[str]] = None):
    ...
    def fetcher(self, *, fetcher_id: FetcherId, fetcher_data: dict) -> Optional[NEWCrudityFetcher]:
